<?php
      ...
      {  
         ...
         $sql = "insert into student (username, studentname, id_college, departmentname, emailid, contactno, password) values ('".$username."','". $studentname."',". $id_college.",'". $departmentname."', '".$emailid."','". $contactno."','".$hashedPwInDb."')";
